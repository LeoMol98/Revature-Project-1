...
public class AbstractReimbursement {
    ...
    public AbstractReimbursement(int id, User author, User resolver, double amount, Status status) {
        super();
        this.id = id;
        this.status = status;
        this.author = author;
    ...
    public AbstractReimbursement(int id, Status status, double amount) {
    }

    public AbstractReimbursement(User author, User resolver, double amount, Status status) {
        this.status = status;
        this.author = author;
        this.resolver = resolver;
        this.amount = amount;
    ...
    public AbstractReimbursement(User author, double amount, Status status) {
        this.status = status;
        this.author = author;
        this.amount = amount;
    }

    public AbstractReimbursement(int id, Status status) {
        this.id = id;
        this.status = status;
    }
